...
// Maps over an array with the provided iterator function, concatenating the resulting arrays
...
const listKeys = object => {
  ...
  if (Array.isArray(object)) return concatMap(object, item => listKeys(item));
